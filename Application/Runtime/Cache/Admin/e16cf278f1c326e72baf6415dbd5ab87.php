    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                                        <li>
                        <a href="/unot/index.php/Admin/Index/lst">后台管理系统</a>
                    </li>
                                        <li>
                        <a href="/unot/index.php/Admin/Article/lst">文章管理</a>
                    </li>
...
<div class="row">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="" placeholder="" name="art_title" required=""  type="text"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="" placeholder="" name="art_peopel" required=""  type="text"/>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">所属类型</label>
                            <div class="col-sm-6">
                                <select name="art_cate" style="width: 100%;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea id="content" name="art_content" ></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
    ...
    <script src="/unot/Public/ueditor/ueditor.config.js"></script>
    <script src="/unot/Public/ueditor/ueditor.all.min.js"></script>
    <script src="/unot/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
