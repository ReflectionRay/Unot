        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="/unot/index.php/Admin/Cate/lst">栏目管理</a>
                    </li>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="catename" value="<?php echo ($cates["catename"]); ?>" placeholder="" name="catename" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id" class="col-sm-2 control-label no-padding-right">是否开放</label>
                                            <div class="col-sm-6">
                                                <select name="open" style="width: 100%;">
                                                    <option value="0" <?php if($cates['open'] == 0): ?>selected="selected"<?php endif; ?> >开放</option>
                                                    <option value="1" <?php if($cates['open'] == 1): ?>selected="selected"<?php endif; ?> >私密</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
