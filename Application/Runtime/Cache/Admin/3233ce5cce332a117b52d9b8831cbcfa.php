...
<button type="button" tooltip="添加商品" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/unot/index.php/Admin/Article/add'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="25%">文章名称</th>
                                <th class="text-center" width="25%">文章作者</th>
                                <th class="text-center" width="25%">所属类型</th>
                        ...
                        <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center" ><?php echo ($vo["art_title"]); ?></td>
                                <td align="center" ><?php echo ($vo["art_people"]); ?></td>
                                <td align="center" ><?php echo ($vo["art_cate"]); ?></td>
                                <td align="center">
                                    <a href="/unot/index.php/Admin/Article/edit/id/<?php echo ($vo["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="/unot/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>" onClick="warning('确实要删除吗')" class="btn btn-danger btn-sm shiny">
